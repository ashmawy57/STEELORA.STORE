...
const WHATSAPP_NUMBER = "201107754111";
...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  // Show tooltip briefly on first appear
  useEffect(() => {
    if (isVisible) {
  ...
  const defaultMessage = isArabic
    ? "مرحباً ستيلورا! أنا مهتم بمنتجاتكم الفاخرة. ممكن تساعدوني؟"
    : "Hi STEELORA! I'm interested in your luxury outdoor gear. Can you help me?";
